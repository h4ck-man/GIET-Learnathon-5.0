		...
		<Card class="h-fit">
			<CardHeader>
				<CardTitle class="flex items-center gap-2 text-base">
					<ShieldAlertIcon class="text-amber-500 size-5" />
					Emergency Contacts
				</CardTitle>
			</CardHeader>
			<CardContent class="space-y-3 text-xs">
				<div class="flex items-center justify-between border-b pb-2">
					<span class="text-muted-foreground">Hostel Warden Office</span>
					<span class="font-mono font-medium">+91 (06857) 250-101</span>
				</div>
				<div class="flex items-center justify-between border-b pb-2">
					<span class="text-muted-foreground">Campus Security (24x7)</span>
					<span class="font-mono font-medium">+91 (06857) 250-999</span>
				</div>
				<div class="flex items-center justify-between">
					<span class="text-muted-foreground">Medical Center</span>
					<span class="font-mono font-medium">+91 (06857) 250-108</span>
				</div>
			</CardContent>
		</Card>
	</div>
