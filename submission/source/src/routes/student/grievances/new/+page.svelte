		...
		<form onsubmit={handleSubmit} class="space-y-5" novalidate>
			<div class="space-y-1.5">
				<div class="flex items-center justify-between">
					...
					<span class="text-muted-foreground text-xs font-mono">{title.length} / 150</span>
				</div>
				<Input
					id="title"
			...
			<div class="space-y-1.5">
				<div class="flex items-center justify-between">
					...
					<span class="text-muted-foreground text-xs font-mono">{description.length} / 3000</span>
				</div>
				<Textarea
					id="description"
					rows={6}
